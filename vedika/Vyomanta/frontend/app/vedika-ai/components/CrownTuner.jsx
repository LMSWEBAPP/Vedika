...
const AVATAR_TABS = [
  { name: 'Ask Vedika', color: '#39FF14', short: 'Ask' },
  { name: 'Code with Vedika', color: '#FF6EFF', short: 'Code' },
  { name: 'Code Puzzles', color: '#FF3131', short: 'Puzzles' },
  { name: 'Viva and Interview', color: '#FF5C00', short: 'Viva' },
];
